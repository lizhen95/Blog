...
<div region="north" style="height: 78px;background-color: #E0ECFF">
	<table style="padding: 5px" width="100%">
		<tr>
			<td width="50%">
				<img style="width: 326px ; height: 60px" alt="logo" src="${pageContext.request.contextPath}/static/images/logo.png">
			</td>
...
<div region="center">
	<div class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="首页" data-options="iconCls:'icon-home'">
			<div align="center" style="padding-top: 100px "><img style="width: 683px; height: 384px" alt="wwcx" src="${pageContext.request.contextPath}/static/images/wwcx.jpg"> </div>
		</div>
	</div>
</div>
